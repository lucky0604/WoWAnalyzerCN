  ...
  return (
    ...
    >
      ...
      {info.combatant.hasTalent(TALENTS.SENTINEL_TALENT) ? (
        <>
          <p>
            <Trans id="guide.hunter.survival.sections.hero.sentinel">
              Sentinel: It is important for Survival Hunters to ensure proper management of
              Sentinel's Mark in order to maximise damage. Each time you consume{' '}
              <SpellLink spell={SPELLS.TIP_OF_THE_SPEAR_CAST} /> you have a chance to mark a target
              you're in combat with. It is important to always have a charge of bomb ready to
              consume the mark so that you do not waste applications.
            </Trans>
          </p>
        ...
        <>
          <p>
            <Trans id="guide.hunter.survival.sections.hero.packLeader">
              ...
              <SpellLink spell={SPELLS.STAMPEDE_READY_BUFF} /> is key to maximizing your damage
              output to ensure the boar and the stampede do not miss on the vertical axis.
            </Trans>
          </p>
