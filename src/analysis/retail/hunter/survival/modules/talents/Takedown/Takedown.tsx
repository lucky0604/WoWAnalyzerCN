...
export default class Takedown extends Analyzer {
  ...
  checklist(cast: TakedownCast): {
    ...
    if (this.hasTwinFangs) {
      ...
      items.push({
        label: (
          <Trans id="hunter.survival.takedown.tipAtCast">
            <SpellLink spell={SPELLS.TIP_OF_THE_SPEAR_CAST} /> at cast{' '}
            <TooltipElement
              content={
                <Trans id="hunter.survival.takedown.twinFangsTipTooltip">
      ...
      items.push({
        label: (
          <Trans id="hunter.survival.takedown.tipAtCast">
            ...
            <TooltipElement
              content={
                <Trans id="hunter.survival.takedown.noTwinFangsTipTooltip">
    ...
    items.push({
      label: (
        <Trans id="hunter.survival.takedown.tipWaste">
          <SpellLink spell={SPELLS.TIP_OF_THE_SPEAR_CAST} />
          {'  waste '}
          <TooltipElement
            content={
              <Trans id="hunter.survival.takedown.tipWasteTooltip">
