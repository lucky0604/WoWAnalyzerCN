            ...
            <div style={{ padding: '8px' }}>
              {plotOneVariableBinomChart(
                ...
                <p>
                  <>
                    {t({
                      id: 'hunter.beastmastery.direCommand.likelihoodText.p1',
                      message: 'Likelihood of getting ',
                    })}
                    <em>
                      {t({
                        id: 'hunter.beastmastery.direCommand.likelihoodText.em',
                        message: 'exactly',
                      })}
                    </em>
                    {t({
                      id: 'hunter.beastmastery.direCommand.likelihoodText.p2',
                    ...
                    {t({
                      id: 'hunter.beastmastery.direCommand.likelihoodText.p3',
                      message: ' casts.',
                    })}
                  </>
                </p>
