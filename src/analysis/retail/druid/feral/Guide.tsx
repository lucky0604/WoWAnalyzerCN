...
function ResourceUseSection({ modules, events, info }: GuideProps<typeof CombatLogParser>) {
  return (
    <Section title={t({ id: 'druid.feral.guide.resource_use', message: 'Resource Use' })}>
      <SubSection title={t({ id: 'druid.feral.guide.energy', message: 'Energy' })}>
        <p>
          <Trans id="druid.feral.guide.energy_description">
...
function AdvancedRotationSection({ modules, events, info }: GuideProps<typeof CombatLogParser>) {
  return (
    <Section
      title={t({ id: 'druid.feral.guide.advanced_rotation', message: 'Advanced Rotation' })}
    >
      <p>
        <Trans id="druid.feral.guide.advanced_rotation_description">
