            ...
            {this.hasFourPiece && (
              <>
                ...
                {t({
                  ...
                  message:
                    ', and Incarnation / Convoke, and extends Genesis duration by 8 sec. The 4pc value is all healing from those granted stacks plus the healing during the final 8 sec of each Rejuvenation-granted stack. Pre-pull stacks always count fully towards the 2pc.',
                })}
              </>
            )}
          </>
