...
function CooldownSection({ modules }: GuideProps<typeof CombatLogParser>) {
  return (
    <Section title={t({ id: 'warlock.demonology.section.cooldowns', message: 'Cooldowns' })}>
      <Section title={t({ id: 'warlock.demonology.section.cooldownUsage', message: 'Cooldown Usage' })}>
        <CooldownSubsection />
      </Section>
      <Section title={t({ id: 'warlock.demonology.section.demonicTyrant', message: 'Demonic Tyrant' })}>
        <DemonicTyrantGuide />
      </Section>
    </Section>
  );
...
function DefensivesSection({ modules, events, info }: GuideProps<typeof CombatLogParser>) {
  return (
    <Section title={t({ id: 'warlock.demonology.section.defensives', message: 'Defensives' })}>
      <Section title={t({ id: 'warlock.demonology.section.healthstoneTracker', message: 'Healthstone Tracker' })}>
