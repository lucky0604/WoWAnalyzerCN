  ...
  return (
    <>
      ...
      <Section title={t({ id: 'warlock.destruction.section.core', message: 'Core' })}>
        ...
        <Section title={t({ id: 'warlock.destruction.section.cooldownUsage', message: 'Cooldown Usage' })}>
          <CooldownSubsection />
        </Section>
      </Section>
      ...
      <Section title={t({ id: 'warlock.destruction.section.rotation', message: 'Rotation' })}>
        {modules.backdraft?.active && (
          <Section title={t({ id: 'warlock.destruction.section.backdraftUsage', message: 'Backdraft Usage' })}>
            <BackdraftGuide
        ...
        {modules.havocAnalyzer?.active && (
          <Section title={t({ id: 'warlock.destruction.section.havocUsage', message: 'Havoc Usage' })}>
            <HavocGuide
      ...
      <Section title={t({ id: 'warlock.destruction.section.defensives', message: 'Defensives' })}>
        <Section title={t({ id: 'warlock.destruction.section.healthstoneTracker', message: 'Healthstone Tracker' })}>
      ...
      <Section title={t({ id: 'warlock.destruction.section.resourceUsage', message: 'Resource Usage' })}>
