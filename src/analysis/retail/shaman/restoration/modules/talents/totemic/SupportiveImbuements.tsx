    ...
    return (
      ...
      >
        <TalentSpellText talent={TALENTS.SUPPORTIVE_IMBUEMENTS_TALENT}>
          ...
          <div>
            <small>
              {t({ id: 'shaman.restoration.si.bonus_healing', message: 'Bonus Healing Done' })}
            </small>
          </div>
          <div>
          ...
          <div>
            <small>
              {t({
                id: 'shaman.restoration.si.duration_extension',
                message: 'Healing Totem Duration Extension',
              })}
            </small>
          </div>
          <div>
