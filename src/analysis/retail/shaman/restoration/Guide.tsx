...
export default function Guide({ modules, events, info }: GuideProps<typeof CombatLogParser>) {
  return (
    <>
      <Section title={t({ id: 'shaman.restoration.section.coreSpells', message: 'Core Spells and Buffs' })}>
      ...
      <Section title={t({ id: 'shaman.restoration.section.healingCooldowns', message: 'Healing Cooldowns' })}>
...
function CooldownGraphSubsection({ modules, events, info }: GuideProps<typeof CombatLogParser>) {
  return (
    <SubSection>
      <strong>{t({ id: 'shaman.restoration.cooldownGraph.title', message: 'Cooldown Graph' })}</strong>{t({ id: 'shaman.restoration.cooldownGraph.description', message: ' - this graph shows when you used your cooldowns and how long you waited to use them again. Grey segments show when the spell was available, yellow segments show when the spell was cooling down. Red segments highlight times when you could have fit a whole extra use of the cooldown.' })}
