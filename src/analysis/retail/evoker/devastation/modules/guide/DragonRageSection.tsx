...
export function DragonRageSection({ modules, events, info }: GuideProps<typeof CombatLogParser>) {
  ...
  return (
    ...
    >
      <p>
        <Trans id="guide.evoker.devastation.sections.dragonrage.summary">
          ...
          <SpellLink spell={TALENTS_EVOKER.ANIMOSITY_TALENT} /> to extend the buff duration as long
          as possible. We do this by getting in <strong>at least</strong> 2 rounds of{' '}
      ...
      <p>
        <Trans id="guide.evoker.devastation.sections.dragonrage.summary2">
      ...
      {hasMID1TierSet && (
        <p>
          <Trans id="guide.evoker.devastation.sections.dragonrage.tierSet">
      ...
      {hasIridescence && (
        <p>
          <Trans id="guide.evoker.devastation.sections.dragonrage.iridescence">
            When playing with{' '}
            <strong>
