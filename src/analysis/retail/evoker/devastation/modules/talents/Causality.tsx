    ...
    const cdrSourceItems = [
      {
        ...
        valueTooltip:
          ...
          ).toFixed(2) + t({ id: 'evoker.devastation.causality.cdrTooltip', message: 's CDR' }),
      ...
      },
      {
        ...
        valueTooltip:
          (
            this.sourceData[SPELLS.DISINTEGRATE.id].CDR + this.sourceData[SPELLS.DISINTEGRATE.id].CDRMIDS24P
          ).toFixed(2) + t({ id: 'evoker.devastation.causality.cdrTooltip', message: 's CDR' }),
        value: this.sourceData[SPELLS.DISINTEGRATE.id].CDR + this.sourceData[SPELLS.DISINTEGRATE.id].CDRMIDS24P,
      },
    ];
    ...
    const effectiveCDRItems = [
      {
        ...
        label: t({ id: 'evoker.devastation.causality.effectiveCDR', message: 'Effective CDR' }),
        valueTooltip:
          (effectiveCDR + MIDS24P_effectiveCDR).toFixed(2) +
      ...
      },
      {
        ...
        valueTooltip:
          (wastedCDR + MIDS24P_wastedCDR).toFixed(2) +
          t({
