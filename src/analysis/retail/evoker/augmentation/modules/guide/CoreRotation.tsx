...
export function CoreRotationSection({ modules, events, info }: GuideProps<typeof CombatLogParser>) {
  return (
    ...
    >
      <p>
        <>{t({id:'guide.evoker.augmentation.sections.coreRotation.summary.p1',message:"Augmentation's core rotation revolves around proper upkeep of your buffs: "})}<SpellLink spell={TALENTS_EVOKER.EBON_MIGHT_TALENT} />{t({id:'guide.evoker.augmentation.sections.coreRotation.summary.p2',message:', '})}<SpellLink spell={TALENTS_EVOKER.PRESCIENCE_TALENT} />{t({id:'guide.evoker.augmentation.sections.coreRotation.summary.p3',message:', '})}<SpellLink spell={SPELLS.SHIFTING_SANDS_BUFF} />{t({id:'guide.evoker.augmentation.sections.coreRotation.summary.p4',message:', and '})}<SpellLink spell={TALENTS_EVOKER.DUPLICATE_1_AUGMENTATION_TALENT} />{t({id:'guide.evoker.augmentation.sections.coreRotation.summary.p5',message:'. While using your empowers: '})}<SpellLink spell={SPELLS.FIRE_BREATH} />{t({id:'guide.evoker.augmentation.sections.coreRotation.summary.p6',message:' and '})}<SpellLink spell={SPELLS.UPHEAVAL} />{t({id:'guide.evoker.augmentation.sections.coreRotation.summary.p7',message:' on cooldown, along with spending essence on '})}<SpellLink spell={TALENTS_EVOKER.ERUPTION_TALENT} />{t({id:'guide.evoker.augmentation.sections.coreRotation.summary.p8',message:'; using '})}<SpellLink spell={SPELLS.LIVING_FLAME_CAST} />{t({id:'guide.evoker.augmentation.sections.coreRotation.summary.p9',message:' to fill in the gaps.'})}</>
      </p>
      <p>
        <>{t({id:'guide.evoker.augmentation.sections.coreRotation.mainCD.p1',message:'Your main cooldown, '})}<SpellLink spell={TALENTS_EVOKER.BREATH_OF_EONS_TALENT} />{t({id:'guide.evoker.augmentation.sections.coreRotation.mainCD.p2',message:', should be used when enemies will survive its full duration, favouring high damage phases.'})}</>
      </p>
      ...
      <SubSection
        title={t({
          id: 'guide.evoker.augmentation.sections.coreRotation.buffGraph.title',
          message: 'Buff Graph',
        })}
      >
        <>{t({id:'guide.evoker.augmentation.sections.coreRotation.buffGraph.summary.p1',message:'This graph shows your uptime of '})}<SpellLink spell={TALENTS_EVOKER.EBON_MIGHT_TALENT} />{t({id:'guide.evoker.augmentation.sections.coreRotation.buffGraph.summary.p2',message:' and '})}<SpellLink spell={TALENTS_EVOKER.DUPLICATE_1_AUGMENTATION_TALENT} />{t({id:'guide.evoker.augmentation.sections.coreRotation.buffGraph.summary.p3',message:', as well as how many '})}<SpellLink spell={TALENTS_EVOKER.PRESCIENCE_TALENT} />{t({id:'guide.evoker.augmentation.sections.coreRotation.buffGraph.summary.p4',message:' buffs you had active over the course of the encounter. Use this to ensure that you are properly upkeeping your buffs.'})}</>
...
function BlisteringScalesSection({ modules, info }: GuideProps<typeof CombatLogParser>) {
  ...
  return (
    <SubSection
      title={t({
        id: 'guide.evoker.augmentation.sections.coreRotation.blisteringScales.title',
        message: 'Blistering Scales',
      })}
    >
      <ExplanationRow>
        <Explanation>
          <p>
            <><strong>
              ...
              </strong>{t({id:'guide.evoker.augmentation.sections.coreRotation.blisteringScales.summary.text',message:' provides your target with 20% of your armor. This should be kept up on the currently actively tanking player.'})}</>
          </p>
        </Explanation>
        <RoundedPanel>
          <p>
...
function EssenceGraphSection({ modules, events, info }: GuideProps<typeof CombatLogParser>) {
  ...
  return (
    <SubSection
      title={t({
        id: 'guide.evoker.augmentation.sections.coreRotation.essenceGraph.title',
...
function AlwaysBeCastingSection({ modules, events, info }: GuideProps<typeof CombatLogParser>) {
  return (
    <SubSection
      title={t({
        id: 'guide.evoker.augmentation.sections.coreRotation.alwaysBeCasting.title',
        message: 'Always be Casting',
      })}
    >
      <p>
        <em><b>{t({id:'guide.evoker.augmentation.sections.coreRotation.alwaysBeCasting.summary.bold',message:'Continuously chaining casts throughout an encounter is the single most important thing for achieving good DPS as a caster.'})}</b></em>
      </p>
      <p>
        <Trans id="guide.evoker.augmentation.sections.coreRotation.alwaysBeCasting.summary2">
      ...
      <p>
        <Trans id="guide.evoker.augmentation.sections.coreRotation.alwaysBeCasting.value">
          Active Time:{' '}
        </Trans>
