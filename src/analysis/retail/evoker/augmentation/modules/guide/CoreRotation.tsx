...
export function CoreRotationSection({ modules, events, info }: GuideProps<typeof CombatLogParser>) {
  return (
    ...
    >
      <p>
        <Trans id="guide.evoker.augmentation.sections.coreRotation.summary">
          ...
          empowers: <SpellLink spell={SPELLS.FIRE_BREATH} /> and{' '}
          <SpellLink spell={SPELLS.UPHEAVAL} /> on cooldown, along with spending essence on{' '}
          <SpellLink spell={TALENTS_EVOKER.ERUPTION_TALENT} />; using{' '}
          <SpellLink spell={SPELLS.LIVING_FLAME_CAST} /> to fill in the gaps.
        </Trans>
      </p>
      <p>
        <Trans id="guide.evoker.augmentation.sections.coreRotation.mainCD">
      ...
      >
        <Trans id="guide.evoker.augmentation.sections.coreRotation.buffGraph.summary">
          ...
          <SpellLink spell={TALENTS_EVOKER.PRESCIENCE_TALENT} /> buffs you had active over the
          course of the encounter. Use this to ensure that you are properly upkeeping your buffs.
        </Trans>
  ...
  return (
    ...
    >
      <ExplanationRow>
        <Explanation>
          <p>
            <Trans id="guide.evoker.augmentation.sections.coreRotation.blisteringScales.summary">
              <strong>
                <SpellLink spell={TALENTS_EVOKER.BLISTERING_SCALES_TALENT} />
              </strong>{' '}
              provides your target with 20% of your armor. This should be kept up on the currently
              actively tanking player.
            </Trans>
          </p>
        </Explanation>
        <RoundedPanel>
...
function EssenceGraphSection({ modules, events, info }: GuideProps<typeof CombatLogParser>) {
  ...
  return (
    ...
    >
      <p>
        <Trans id="guide.evoker.augmentation.sections.coreRotation.essenceGraph.summary">
...
function AlwaysBeCastingSection({ modules, events, info }: GuideProps<typeof CombatLogParser>) {
  return (
    ...
    >
      <p>
        <Trans id="guide.evoker.augmentation.sections.coreRotation.alwaysBeCasting.summary">
          <em>
            <b>
