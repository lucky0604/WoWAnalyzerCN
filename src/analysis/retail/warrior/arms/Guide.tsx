...
export default function Guide({ modules, events, info }: GuideProps<typeof CombatLogParser>) {
  return (
    <>
      <Section
        title={t({
          id: 'warrior.arms.section.preface',
      ...
      <Section
        title={t({
          id: 'warrior.arms.section.alwaysBeCasting',
...
function CooldownSection({ modules, info }: GuideProps<typeof CombatLogParser>) {
  return (
    <Section
      title={t({
        id: 'warrior.arms.section.cooldowns',
        message: 'Cooldowns',
      })}
    >
...
function RotationSection({ modules, info }: GuideProps<typeof CombatLogParser>) {
  return (
    <Section
      title={t({
        id: 'warrior.arms.section.rotation',
        message: 'Rotation',
      })}
    >
      <p>
      ...
      <div>
        {t({
          id: 'warrior.arms.rotation.potentialInaccuracy',
          message: 'Potential areas of inaccuracy:',
        })}
        <ul>
          <li>
            {t({
              id: 'warrior.arms.rotation.inaccuracy1',
              message: 'Holding abilities for upcoming add spawns or damage amps',
            })}
          </li>
          <li>
            {t({
              id: 'warrior.arms.rotation.inaccuracy2',
              message: 'Multiple targets',
            })}
          </li>
          <li>
            {t({
              id: 'warrior.arms.rotation.inaccuracy3',
              message: 'Movement or periods of downtime',
            })}
          </li>
        </ul>
      </div>
      <p>
        <strong>
          {t({
            id: 'warrior.arms.rotation.note',
            message: 'NOTE:',
          })}
        </strong>{' '}
        {t({
          id: 'warrior.arms.rotation.noteDescription',
          message: 'The priority list below does not include',
        })}{' '}
