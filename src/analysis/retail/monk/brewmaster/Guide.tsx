...
export default function Guide({ info }: GuideProps<typeof CombatLogParser>) {
  return (
    <>
      ...
      <Section title={t({ id: 'monk.brewmaster.section.staggerManagement', message: 'Stagger Management' })}>
        <p>
          <>
            {t({
              id: 'monk.brewmaster.staggerManagement.description.p1',
              message: "Brewmaster's core defensive loop uses ",
            })}
            ...
            {t({
              id: 'monk.brewmaster.staggerManagement.description.p3',
              message:
                ' to convert 60-70% of burst damage into a much less dangerous damage-over-time effect (the ',
            })}
            <em>{t({ id: 'monk.brewmaster.staggerManagement.description.p4', message: 'Stagger pool' })}</em>
            {t({
              id: 'monk.brewmaster.staggerManagement.description.p5',
              message:
                '). We have a variety of ways to reduce the damage of this DoT\u2014the most important of which is ',
            })}
            <SpellLink spell={talents.PURIFYING_BREW_TALENT} />
            {t({
              id: 'monk.brewmaster.staggerManagement.description.p6',
              message: ', which reduces the remaining DoT damage by 50% or more.',
            })}
          </>
        </p>
        <StaggerPoolSection />
      ...
      <Section title={t({ id: 'monk.brewmaster.section.rotationAndCooldowns', message: 'Rotation & Cooldowns' })}>
        <SubSection title={t({ id: 'monk.brewmaster.subsection.rotation', message: 'Rotation' })}>
          <AplChoiceDescription />
          <RotationTipBoxRow>
            <CastEfficiencyTipBox title={t({ id: 'monk.brewmaster.tipBox.rotationalSpells', message: 'Rotational Abilities' })} spells={ROTATIONAL_SPELLS} />
            <CastEfficiencyTipBox title={t({ id: 'monk.brewmaster.tipBox.shortCooldownBrews', message: 'Short-Cooldown Brews' })} spells={ROTATIONAL_BREWS} />
            <BlackoutComboTipBox />
          </RotationTipBoxRow>
        </SubSection>
        <SubSection title={t({ id: 'monk.brewmaster.subsection.cooldowns', message: 'Cooldowns' })}>
          <Explanation>
            <p>
              <>
                {t({
                  id: 'monk.brewmaster.cooldowns.description1.p1',
                  message: 'Cooldowns like ',
                })}
                <SpellLink spell={spells.INVOKE_NIUZAO_THE_BLACK_OX_TALENT} />
                {t({
                  id: 'monk.brewmaster.cooldowns.description1.p2',
                  message: ' and ',
                })}
                <SpellLink spell={talents.EXPLODING_KEG_TALENT} />
                {t({
                  id: 'monk.brewmaster.cooldowns.description1.p3',
                  message:
                    ' are a major contributor to your overall damage. As a tank, they are also key to establishing threat on pull and when new enemies spawn or are pulled.',
                })}
              </>
            </p>
            <p>
...
function MasterOfHarmonySection(): JSX.Element | null {
  ...
  return (
    <Section title={t({ id: 'monk.brewmaster.section.masterOfHarmony', message: 'Master of Harmony' })}>
      <SpellUsageSubSection
          ...
          <>
            <p>
              <>
                ...
                {t({
                  id: 'monk.brewmaster.masterOfHarmony.description1.p1',
                  message: ' causes you to accumulate ',
                })}
                <strong>{t({ id: 'monk.brewmaster.masterOfHarmony.description1.bold1', message: 'Vitality' })}</strong>
                {t({
                  id: 'monk.brewmaster.masterOfHarmony.description1.p2',
                  message: ' by doing damage. ',
                })}
                <strong>{t({ id: 'monk.brewmaster.masterOfHarmony.description1.bold2', message: 'Vitality' })}</strong>
                {t({
                  id: 'monk.brewmaster.masterOfHarmony.description1.p3',
                  message: ' is spent by using ',
                })}
                <SpellLink spell={aoh.activeSpender} />
                {t({
                  id: 'monk.brewmaster.masterOfHarmony.description1.p4',
                  message: ' ',
                })}
                <em>{t({ id: 'monk.brewmaster.masterOfHarmony.description1.p5', message: 'and then' })}</em>
                {t({
                  id: 'monk.brewmaster.masterOfHarmony.description1.p6',
                  message: ' doing damage (or healing).',
                })}
              </>
            </p>
            <p>
              <>
                {t({
                  id: 'monk.brewmaster.masterOfHarmony.description2.p1',
                  message: 'This means it is important to use ',
                })}
                <SpellLink spell={aoh.activeSpender} />
                {t({
                  id: 'monk.brewmaster.masterOfHarmony.description2.p2',
                  message: ' periodically ',
                })}
                <em>{t({ id: 'monk.brewmaster.masterOfHarmony.description2.p3', message: "even if you aren't taking much damage" })}</em>
                {t({
                  id: 'monk.brewmaster.masterOfHarmony.description2.p4',
                  message: ' in order to spend the Vitality before you reach the ',
                })}
                <TooltipElement
                  content={t({
                ...
                >
                  {t({ id: 'monk.brewmaster.masterOfHarmony.description2.p5', message: 'cap.' })}
                </TooltipElement>
              </>
            </p>
          </>
        ...
        noCastsTexts={{
          noCastsOverride: (
            <>
              {t({
                id: 'monk.brewmaster.masterOfHarmony.noCasts.p1',
                message: 'You did not cast ',
              })}
              <SpellLink spell={aoh.activeSpender} />
              {t({
                id: 'monk.brewmaster.masterOfHarmony.noCasts.p2',
                message: '. This means you gained almost nothing from your Hero Tree!',
              })}
            </>
          ),
        }}
    ...
    <div className={styles.rotationTipBox}>
      ...
      <p>
        <>
          ...
          {t({
            id: 'monk.brewmaster.blackoutCombo.description.p1',
            message: ' should be spent on ',
          })}
          <SpellLink spell={SPELLS.TIGER_PALM} />
          {t({
            id: 'monk.brewmaster.blackoutCombo.description.p2',
            message:
              ' in virtually all situations. The main exception is during ',
          })}
          ...
          {t({
            id: 'monk.brewmaster.blackoutCombo.description.p4',
            message: ', where you may ignore ',
          })}
          <SpellLink spell={talents.BLACKOUT_COMBO_TALENT}>BoC</SpellLink>
          {t({
            id: 'monk.brewmaster.blackoutCombo.description.p5',
            message: ' entirely.',
          })}
        </>
      </p>
      <div>
        <Table
          ...
          columns={{
            ...
            amountBar: amountBar(
              t({
                id: 'monk.brewmaster.blackoutCombo.combos',
                message: 'Combos',
              }),
            ),
            casts: literalNumberColumn(
              t({
                id: 'monk.brewmaster.blackoutCombo.casts',
                message: 'Casts',
              }),
              'casts',
            ),
  ...
  return (
    <div className={styles.rotationTipBox}>
      ...
      <p>
        <>
          {t({
            id: 'monk.brewmaster.elevatedPurify.description.p1',
            message: 'This compares ',
          })}
          <SpellLink spell={spells.PURIFYING_BREW_TALENT} />
          {t({
            id: 'monk.brewmaster.elevatedPurify.description.p2',
            message: ' casts during ',
          })}
          <SpellLink spell={SPELLS.ELEVATED_STAGGER_BUFF} />
          {t({
            id: 'monk.brewmaster.elevatedPurify.description.p3',
            message:
              ' against your total casts, so you can see how many casts gained the extra High Tolerance value.',
          })}
        </>
      </p>
      <div>
        <Table
          ...
          columns={{
            ...
            elevatedCasts: literalNumberColumn(
              t({
                id: 'monk.brewmaster.elevatedPurify.elevatedCasts',
                message: 'Elevated Casts',
              }),
              'elevatedCasts',
            ),
            elevatedCdrColumn,
