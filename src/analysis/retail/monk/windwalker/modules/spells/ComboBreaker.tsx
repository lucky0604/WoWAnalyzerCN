      ...
      <Statistic
        ...
        tooltip={(() => {
          ...
          return (
            <>
              {t({
                id: 'monk.windwalker.cb.statistic_tooltip.p1',
                message: 'You got a total of ',
              })}
              <strong>
                {total} {t({ id: 'monk.windwalker.cb.statistic_tooltip.procs', message: 'Combo Breaker procs' })}
              </strong>
              {t({
                id: 'monk.windwalker.cb.statistic_tooltip.p2',
                message: ' and ',
              })}
              <strong>
                {t({ id: 'monk.windwalker.cb.statistic_tooltip.p3', message: 'used' })} {consumed}
              </strong>
              {t({
                id: 'monk.windwalker.cb.statistic_tooltip.p4',
                message: ' of them. ',
              })}
              <strong>{overcapped}</strong>
              {t({
                id: 'monk.windwalker.cb.statistic_tooltip.p5',
                message: ' were overcapped and ',
              })}
              <strong>{expired}</strong>
              {t({
                id: 'monk.windwalker.cb.statistic_tooltip.p6',
                message: ' expired unused. The average expected number of procs from your Tiger Palms this fight is ',
              })}
              <strong>{average}</strong>
              {t({
                id: 'monk.windwalker.cb.statistic_tooltip.p7',
                message: ', and you got ',
              })}
              <strong>{total}</strong>
              {t({
                id: 'monk.windwalker.cb.statistic_tooltip.p8',
                message: '.',
              })}
            </>
          );
  ...
  get guideSubsection(): JSX.Element {
    const explanation = (
      <>
        <p>
          <>
            {t({
              id: 'monk.windwalker.cb.explanation1.p1',
              message: 'The ',
            })}
            <SpellLink spell={SPELLS.COMBO_BREAKER_BUFF} />
            {t({
              id: 'monk.windwalker.cb.explanation1.p2',
              message: ' buff makes your next cast of ',
            })}
            <SpellLink spell={SPELLS.BLACKOUT_KICK} />
            {t({
              id: 'monk.windwalker.cb.explanation1.p3',
              message: ' free. It is generated by consumed ',
            })}
            <SpellLink spell={SPELLS.DANCE_OF_CHI_JI_BUFF} />
            {t({
              id: 'monk.windwalker.cb.explanation1.p4',
              message: ' stacks and by ',
            })}
            <SpellLink spell={SPELLS.TIGER_PALM} />
            {t({
              id: 'monk.windwalker.cb.explanation1.p5',
              message: ', which has an 8% chance to trigger it from ',
            })}
            <SpellLink spell={SPELLS.COMBO_BREAKER} />
            {t({
              id: 'monk.windwalker.cb.explanation1.p6',
              message: '. ',
            })}
          </>
          {this.selectedCombatant.hasTalent(TALENTS_MONK.MEMORY_OF_THE_MONASTERY_TALENT) &&
            (() => {
              ...
              return (
                <>
                  {t({
                    id: 'monk.windwalker.cb.explanation1_talent.p1',
                    message: 'With ',
                  })}
                  <SpellLink spell={TALENTS_MONK.MEMORY_OF_THE_MONASTERY_TALENT} />
                  {t({
                    id: 'monk.windwalker.cb.explanation1_talent.p2',
                    message: ', that ',
                  })}
                  <SpellLink spell={SPELLS.TIGER_PALM} />
                  {t({
                    id: 'monk.windwalker.cb.explanation1_talent.p3',
                    message:
                      ' proc chance is increased by 75%, which raises the chance from 8% to ',
                  })}
                  {chance}
                  {t({
                    id: 'monk.windwalker.cb.explanation1_talent.p4',
                    message: '%.',
                  })}
                </>
              );
        ...
        <p>
          <>
            <SpellLink spell={SPELLS.BLACKOUT_KICK} />
            {t({
              id: 'monk.windwalker.cb.explanation2.p1',
              message: ' and ',
            })}
            <SpellLink spell={SPELLS.COMBO_BREAKER} />
            {t({
              id: 'monk.windwalker.cb.explanation2.p2',
              message:
        ...
        <p>
          <>
            {t({
              id: 'monk.windwalker.cb.explanation3.p1',
              message: 'This section is about timing, not raw proc speed. Use ',
            })}
            <SpellLink spell={SPELLS.BLACKOUT_KICK} />
            {t({
              id: 'monk.windwalker.cb.explanation3.p2',
              message:
                ' once it rises to the top of the suggested APL, not just because the buff is active.',
            })}
          </>
        </p>
        <p>
          <>
            {t({
              id: 'monk.windwalker.cb.explanation4.p1',
              message: 'Spend before incoming ',
            })}
            <SpellLink spell={SPELLS.TIGER_PALM} />
            {t({
              id: 'monk.windwalker.cb.explanation4.p2',
              message: ' casts or a planned ',
            })}
            <SpellLink spell={SPELLS.DANCE_OF_CHI_JI_BUFF} />
            {t({
    ...
    return (
      <GuideSection
        ...
        title={t({ id: 'monk.windwalker.cb.title', message: 'Combo Breaker' })}
      ...
      >
        ...
        <div style={{ display: 'grid', gap: '0.75rem', marginTop: '0.75rem' }}>
          ...
          >
            ...
            <div>
              {(() => {
                const riskyTP = this.riskyTP;
                return (
                  <>
                    <strong>{riskyTP}</strong>
                    {t({
                      id: 'monk.windwalker.cb.risky_tp_desc.p1',
                      message: ' casts of ',
                    })}
                    <SpellLink spell={SPELLS.TIGER_PALM} />
                    {t({
