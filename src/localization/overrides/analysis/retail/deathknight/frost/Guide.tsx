...
export default function Guide({ modules, events, info }: GuideProps<typeof CombatLogParser>) {
  return (
    <>
      <Section
        title={t({
          id: 'deathknight.frost.guide.sections.resources.title',
          message: 'Resource Use',
        })}
      >
        <SubSection
          title={t({
            id: 'deathknight.frost.guide.sections.resources.runes.title',
            message: 'Runes',
          })}
        >
          <span>
            {t({
              id: 'deathknight.frost.guide.sections.resources.runes.summary',
              message:
                "Runes are Death Knight's primary resource. Instead of cooldowns on rotational abilities, you are prevented from spamming our strongest spells by the flow of Runes. You can have up to three runes recharging at once. You want to spend runes whenever you have 4 or more runes to make sure none are wasted. This chart shows your available Runes over the course of the fight.",
            })}
        ...
        <SubSection
          title={t({
            id: 'deathknight.frost.guide.sections.resources.runicPower.title',
            message: 'Runic Power',
          })}
        >
          <span>
        ...
        {info.combatant.hasTalent(talents.BREATH_OF_SINDRAGOSA_TALENT) && (
          <SubSection
            title={t({
              id: 'deathknight.frost.guide.sections.resources.cooldowns.title',
            ...
            <span>
              <>
                {t({
                  ...
                  message: 'Getting the most out of resource cooldowns while playing ',
                })}
                ...
                {t({
                  ...
                  message: ' cast without wasting any of the resources granted.',
                })}
              </>
      ...
      <Section
        title={t({
          id: 'deathknight.frost.guide.sections.procs.title',
          message: 'Proc Usage',
        })}
      >
        <SubSection
          title={t({
            id: 'deathknight.frost.guide.sections.procs.killingMachine.title',
        ...
        <SubSection
          title={t({
            id: 'deathknight.frost.guide.sections.procs.rime.title',
            message: 'Rime',
          })}
        >
      ...
      <Section
        title={t({
          id: 'deathknight.frost.guide.sections.cooldowns.title',
          message: 'Cooldowns',
        })}
      >
  ...
  return (
    <SubSection>
      <>
        <strong>
          {t({
            id: 'deathknight.frost.guide.sections.cooldowns.graphTitle',
            message: 'Cooldown Graph',
          })}
        </strong>
        {t({
          id: 'deathknight.frost.guide.sections.cooldowns.graphSummary',
          message:
