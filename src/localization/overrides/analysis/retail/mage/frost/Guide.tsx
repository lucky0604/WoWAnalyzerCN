  ...
  const alwaysBeCastingSubsection = (
    <SubSection title={t({ id: 'mage.frost.subSection.activeTime', message: 'Active Time' })}>
      <Explanation>
        ...
        <p>
          <>{t({ id: 'mage.frost.activeTime.description1.p1', message: 'As mages we have or ' })}
            <SpellLink spell={TALENTS.SHIMMER_TALENT} />
            {t({ id: 'mage.frost.activeTime.description1.p2', message: 'to continue casting while dealing with mechanics that require movement.' })}
          </>
        </p>
        <p>
